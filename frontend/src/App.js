          ...
          <div style={{ maxWidth: '700px', margin: '40px auto', padding: '0 16px' }}>
            <button
              ...
              style={{
                ...
                marginBottom: faqSectionOpen ? '20px' : '0', padding: '8px 0',
              }}
            >
      ...
      {showCommentsPanel && (
        ...
        >
          <div
            ...
            onClick={(e) => e.stopPropagation()}
          >
            {/* Header YouTube-style — "Commentaires X" + drag bar + close */}
            <div style={{
            ...
            {/* Liste des commentaires — fond blanc, texte noir, style YouTube */}
